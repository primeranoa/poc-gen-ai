...
| 1 | PPEESG_INSTR_ATTRIBUTES | PPEESG_INSTR_ATTRIBUTES_BKP | INSTRUMENT_CODE + PILLAR_KEY + APPLICATION_SCOPE |
| 2 | PPEESG_INSTR_ATTRIBUTES_MAN | PPEESG_INSTR_ATTR_MAN_BKP | INSTRUMENT_CODE + PILLAR_KEY + APPLICATION_SCOPE |
| 3 | PPEESG_THRESHOLD | PPEESG_THRESHOLD_BKP | BANKING_GROUP + SERVICE_MODEL + CODE_ESG_THRESHOLD |
| 4 | PPEESG_PILLAR | PPEESG_PILLAR_BKP | BANKING_GROUP + SERVICE_MODEL + CODE_ESG_PILLAR + CODE_CONTROLLO |
